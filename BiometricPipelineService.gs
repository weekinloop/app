...
var BiometricPipelineService = (function () {
  ...
  function checkConsent_(context) {
    if (typeof ConsentService !== 'undefined') {
      // ConsentService aplica a pseudonimizacao; passar o hash novamente
      // consultaria um sujeito diferente do registro de consentimento.
      ConsentService.check(context.subjectId, 'collect');
    }
  }
